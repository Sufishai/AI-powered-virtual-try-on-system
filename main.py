...
if __name__ == '__main__':
    ...
    logging.info("Generating DensePose representation using Detectron2")
    ...
    # parse agnositc
    logging.info("Generating parsing agnostic representation")
    ...
    # Human agnostic
    logging.info("Generating human agnostic mask")
